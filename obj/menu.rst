   ...
   5819 CD DA 5A      [17]   60 	call	_cpct_setPALColour
   ...
   5820 CD A0 5C      [17]   64 	call	_cpct_px2byteM0
   5823 55            [ 4]   65 	ld	d, l
   5824 ED 4B AB 5E   [20]   66 	ld	bc, (_mem_start)
   5828 21 00 40      [10]   67 	ld	hl, #0x4000
   582B E5            [11]   68 	push	hl
   582C D5            [11]   69 	push	de
   582D 33            [ 6]   70 	inc	sp
   582E C5            [11]   71 	push	bc
   582F CD BC 5C      [17]   72 	call	_cpct_memset
                             73 ;src/menu.c:11: cpct_drawSprite(G_logo,
   5832 21 20 20      [10]   74 	ld	hl, #0x2020
   ...
   583E CD 84 5B      [17]   80 	call	_cpct_drawSprite
   ...
   5845 CD 82 5D      [17]   84 	call	_cpct_setDrawCharM0
   ...
   5850 CD E6 5A      [17]   90 	call	_cpct_drawStringM0
                             91 ;src/menu.c:20: do {
   5853                      92 00101$:
                             93 ;src/menu.c:21: cpct_scanKeyboard_f();
   5853 CD 70 5A      [17]   94 	call	_cpct_scanKeyboard_f
                             95 ;src/menu.c:22: } while (cpct_isAnyKeyPressed_f());
   5856 CD 6F 5C      [17]   96 	call	_cpct_isAnyKeyPressed_f
   5859 7D            [ 4]   97 	ld	a, l
   585A B7            [ 4]   98 	or	a, a
