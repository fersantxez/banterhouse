...
; ---------------------------------
_main::
;src/main.c:39: cpct_setStackLocation ((u8*) 0x7FFF); //Move stack to right before double buffer 0X8000
	ld	hl, #0x7fff
	call	_cpct_setStackLocation
;src/main.c:40: cpct_disableFirmware();
	call	_cpct_disableFirmware
;src/main.c:42: cpct_setVideoMode(0); //160x200; 16 colors in screen
	ld	l, #0x00
	call	_cpct_setVideoMode
;src/main.c:43: cpct_setPalette(paleta,16);
	ld	hl, #0x0010
	push	hl
	ld	hl, #_paleta
	push	hl
