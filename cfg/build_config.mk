...
##
# Use an externally supplied CPCtelera when available, otherwise fall back to
# the native, repository-local toolchain used by this project.
export CPCT_PATH ?= $(CURDIR)/.tools/cpctelera/cpctelera
